...
def create_nodp_parser():
    ...
    #parser.add_argument("-g", "--num-gpu", dest="num_gpu", type=int, default=0)
    return parser
...
def create_dp_parser():
    ...
    parser.add_argument("-g", "--num-gpu", dest="num_gpu", type=int, default=1)
    # parser.add_argument("-g", "--num-cpu", dest="num_cpu", type=int, default=1)
    ...
    parser.add_argument("--total-step", dest="total_step", type=int)
    parser.add_argument("--has_gpu", dest="has_gpu", type=int, default=1)
    return parser
